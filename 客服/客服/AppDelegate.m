...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *kefuNav = [[UINavigationController alloc] initWithRootViewController:kefuVC];
    [self.window setRootViewController:kefuNav];
    return YES;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Darksnake.__" in the application's documents directory.
